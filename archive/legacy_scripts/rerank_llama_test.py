...
source_path = results_dir / "llama_pinecone_test.json"
output_path = results_dir / "llama_rerank_test.json"
metrics_path = results_dir / "beir_metrics_llama_rerank_test.json"
