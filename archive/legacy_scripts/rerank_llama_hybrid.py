...
# Read hybrid candidates and save separate reranking results.
source_path = results_dir / "llama_hybrid_train.json"
output_path = results_dir / "llama_hybrid_rerank_train.json"
metrics_path = results_dir / "beir_metrics_llama_hybrid_rerank_train.json"
...
print("\nLlama + BM25 hybrid reranking — TRAIN")
